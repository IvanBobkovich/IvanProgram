...
* Сost – the total cost of the car;
...
* Client name – maximum length of 90 characters; 
* Car description – maximum length of 90 characters; 
...
* Number of orders – the number of customer orders;
...
* Phone - maximum length of 45 characters;
...
* Car number  – unique machine number; 
* Brand - car brand;
...
* Car number – unique, maximum length of 30 characters; 
